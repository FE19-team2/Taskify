...
export const inputVariants = cva('transition-colors duration-200 ease-in-out ', {
  variants: {
    variant: {
      primary: ` 
        ...
        `,
      secondary: `
          bg-black-400 border boder-gray-700 outline-none
      ...
      comment: `
          bg-transparent w-[554px] h-[39px] px-[20px] py-[10px] border border-gray-400 rounded-[100px] outline-none overflow-hidden
    ...
    size: {
      ...
      pc: `w-[290px] h-[140px] px-[20] py-[20px]  border border-gray-700 rounded-[14px]`,

      mo: `w-[290px] h-[120px] px-[20] py-[16px]  border border-gray-700 rounded-[12px]`,
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      status: 'full',
      class:
        'w-[584px] h-[220px]  rounded-[14px] border-[1.5px]  text-white   rounded-[14px] overflow',
    },
    {
      variant: 'comment',
      status: 'completed',
