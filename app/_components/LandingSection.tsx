...
export default function LandingSection({
  ...
  return (
    <section
      className={`flex flex-col px-[30px] pt-5 pb-20 md:py-25 items-center lg:justify-between lg:px-60 lg:flex-row ${isReverse ? 'lg:flex-row-reverse' : ''}`}
    >
      <Image
        src={imageSrc}
      ...
      <div className="flex gap-3 md:gap-3.5 flex-col md:w-[535px] lg:w-[554px]">
